...
namespace MAY
{
    ...
    public class CheckSystemVFX : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            if (this.GetComponent<CheckSystemVFX>() && hasError == false)
            {
                Debug.Log("<color=#DDA0DD><size=16><i>" + gameObject.name + "的CheckSystemVFX腳本未移除" + "</i></size></color>");
            }
            else {
