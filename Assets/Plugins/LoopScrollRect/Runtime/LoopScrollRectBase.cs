...
{
    [Serializable]
    public class ScrollToCenterProperties
    {
        public bool enable;
        public float speed;
    }
    ...
    {
        [SerializeField, Tooltip("子元素自動置中")]
        public ScrollToCenterProperties scrollToCenterProperties = new ScrollToCenterProperties { enable = false, speed = 100f };
        ...
        public void ScrollToCell(int index, float speed)
        {
            ...
            //StartCoroutine(ScrollToCenterCoroutine(index, speed));
        }
